			 ...
			 <div class="top-nav">
						...
						<ul id="nav">
							 <li><a href="index.php#section-1"  onclick="javascript:window.open('index.php#section-1','_self')">                            Home</a></li>
							   <li><a href="bd.html"   onclick="javascript:window.open('bd.html','_self')">                              Know About BD</a></li>
                        ...
                        <li><a href="category.php" onclick="javascript:window.open('category.php','_self')">Offers</a></li>                             
